...
COMMAND_ENV = {
    ...
    "PATH": "/home/user/.cargo/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/usr/lib/rustup/bin:/usr/lib/ruby/gems/3.0.0/gems"
}
CHARSET = "UTF-8"
